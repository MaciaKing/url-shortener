            ...
            { data: "url" },
            {
                ...
                render: function (data, type, row) {
                    return `<button type="button" class="btn btn-danger delete-button" data-url="${row.custom_url}">
                            ...
                            <button type="button" class="btn btn-primary arrow-button" data-url="${row.url}" onclick="arrowButtonClicked('${row.url}')">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
...
function arrowButtonClicked(url){
    console.log(url)
